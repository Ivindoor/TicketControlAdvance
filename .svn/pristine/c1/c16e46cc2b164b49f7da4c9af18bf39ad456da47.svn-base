...
<div class="jumbotron bg-transparent padding-0">
	<div class="container-fluid" style='margin-bottom: 10%'>
		<div id="icons-list"
			...
			<h1 class="text-gray-darker visible-lg">Sanmina</h1>
			<h2 class="text-gray-darker visible-md">Sanmina</h2>
			<p class="text-gray-darker mtop-20">
				<i>Esta es una aplicación para el control y seguimiento de todos
					los componentes manejados en Sanmina, esto para llevar mejor un
					control al momento de enviar el producto terminado. </i>
			</p>
			<p class="visible-xs visible-sm text-center">
				<a href="#" class="btn btn-lg btn-primary mbottom-20"> </a>
			</p>
		</div>

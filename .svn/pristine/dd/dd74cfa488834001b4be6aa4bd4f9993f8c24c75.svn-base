...
<title>TICKET CONTROL ADVANCE</title>
<style>
body.loading {
	overflow: hidden;
}
...
<link rel="stylesheet" type="text/css"
	href="resources/css/OtherDataTableBootstrap.min.css">
<link rel="stylesheet" type="text/css"
	href="resources/css/DataTableBootstrap.min.css">
<!-- Notifications -->
...
<script>
	...
	$(document).ready(function(){
		$( "#failLogin" ).hide();
			...
			var idUser = '<%= session.getAttribute("ID_USER") %>';
			var user_name = '<%= session.getAttribute("LOGGEDIN_USER") %>';
			var user_level = '<%= session.getAttribute("LEVEL_USER") %>';

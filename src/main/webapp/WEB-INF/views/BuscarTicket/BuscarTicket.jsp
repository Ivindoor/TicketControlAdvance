						...
						<div class="row">
							<div class="col-sm-offset-1">
								<p class="pull-left  h4 uppercase navbar-text hidden-xs"
									id="form-name">Eliminar Ticket</p>
							</div>
						</div>
					</div>
				...
				<section class="panel panel-default">
											...
											<div class="col-md-8 col-md-offset-2  mbottom-20">
												<div class="panel panel-gray-dark">
													...
													<div class="panel-body">
														<textarea id="txtComment" class="form-control" rows="5"
															required></textarea>
													</div>
					...
					<div class="row">
						<div class="col-sm-5 col-md-offset-2 ">
							<select name="slcProject" id="slcProject" class="form-control">
								<option disabled selected value="0">Seleccione una
									opcion de busqueda</option>
...
<script src="resources/js/SearchTicket.js"></script>

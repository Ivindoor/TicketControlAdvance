...
public class UserDaoImpl extends AbstractDAO implements UserDao {
	...
	public Users findUserByUserLogin(String usLogin) {
		System.out.println("login " + usLogin);
		SQLQuery query = getSessionTicket().createSQLQuery("SELECT * FROM tbl_UserLogin WHERE universalLogin = :usLogin")
				.addEntity(Users.class);
		query.setString("usLogin", usLogin);

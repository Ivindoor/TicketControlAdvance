...
public class BuildPdfCREE {
	...
	public BuildPdfCREE(String partNumber, String ticket, String project, long qty, String description, String container) {
	...
	public Document buildDoc(Document document) {
		try {
			...
			PdfPCell cellContainer = new PdfPCell(new Paragraph("Container   " + "\n" + container, arial15));

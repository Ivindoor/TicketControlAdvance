			...
			<div class="panel panel-default mbottom-10" id="form-chunk">
				<section class="panel panel-default">
					...
					<div class="panel-body">
						<div class="row">
							<div class="col-md-4">
								...
								<div class="form group mandatory clearfix">
									<input type="text" class="form-control input-sm "
										id="txtTicket" name="txtTicket" disabled="disabled">
								</div>
							</div>
							...
							<div class="col-md-4">
								...
								<div class="form group mandatory clearfix">
									<input type="text" name="txtContainer" id="txtContainer"
										class="form-control input-sm" placeholder="Ingrese un serial aaaaaaaaa"
										disabled="disabled">
								</div>
							</div>
						</div>
						<div id="divPO" class="row" style="display: none">
							<div class="col-sm-2 col-md-offset-0">
								<div class="form group  clearfix">
									<label for="exampleInputEmail1" id="lblPO">PO</label> <input
										type="tel" class="form-control input-sm " id="txtPo"
										disabled="disabled" placeholder="Ingrese la PO">
								</div>
							</div>

							<div class="col-sm-2 col-md-offset-0">
								<div class="form group  clearfix">
									<label for="exampleInputEmail1" id="lblSO">SO</label> <input
										type="tel" class="form-control input-sm " id="txtSo"
										disabled="disabled" placeholder="Ingrese la SO">
								</div>
							</div>
						</div>
						<div class="row">
							<div class="col-md-4" id="divQty" style="display: none">
								<div class="form group  clearfix">
									<h4>
										<label for="exampleInputEmail1" id="lblQuantity">Cantidad</label>
									</h4>
									<input type="number" class="form-control input-sm " id="txtQty"
										disabled="disabled" placeholder="Ingrese la cantidad">
								</div>
							</div>
						</div>
						<br>
						<div id="divCheck" class="row" style="display: none">
							<!-- 						style=" display:none" -->
							<div id="divAccesorios" class="col-sm-2 col-md-offset-0">
								<div class="form group  clearfix">
									<label for="exampleInputEmail1" id="lblAccesorios"
										class="checkbox-inline"><input type="checkbox"
										id="chkAccesorios"> Accesorios</label>
								</div>
							</div>
							<div id="divBoxes" class="col-sm-2 col-md-offset-0">
								<div class="form group  clearfix">
									<label for="exampleInputEmail1" id="lblBoxes"
										class="checkbox-inline"><input type="checkbox"
										id="chkAccesorios"> Serial por caja</label>
								</div>
							</div>
							<div id="divChassis" class="col-sm-2 col-md-offset-0">
								<div class="form group  clearfix">
									<label for="exampleInputEmail1" id="lblChasis"
										class="checkbox-inline"><input type="checkbox"
										id="chkAccesorios"> Chassis/Frame </label>
								</div>
							</div>
							<button class="btn btn-primary" type="button"
								style="width: 150px;">
								Boxes <span id="btnBox" class="badge">0</span>
							</button>
						</div>
						<div class="row">
						...
						<div id='contenidoPartial'>
							<jsp:include page="TableDivPartial.jsp"></jsp:include>
						</div>
						<br>


						<!--   -->
						<div class="row" id="divGlobalValid" style="display: none;">
							<div class="col-sm-6 col-sm-offset-3 col-xs-10 pull-center">
								<hr>
								<h4 align="center">Validaciones</h4>
								<!-- 								<div class="row"> -->
								<!-- 									<button class="btn btn-primary" type="button" -->
								<!-- 										style="width: 150px;"> -->
								<!-- 										Validaciones <span id="btnValid" class="badge">0</span> -->
								<!-- 									</button> -->
								<br> <input type="text" id="txtValid"
									class="form-control input-sm"
									placeholder="Ingrese un contenedor para validar" width="100">
								<!-- 								</div> -->
							</div>

							<div id="divValid">
								<jsp:include page="TblDivValidation.jsp"></jsp:include>
							</div>
						</div>
						<br>
						...
						<div id="divInstruction" style="display: none;">
							<div class="row">
								<div class="col-md-12  mbottom-20">
									<hr>
									<h4>Información de la instruccion</h4>
								</div>
							</div>
							<div id='dataInfortamtion' style="display: none;">
								<div class="row">
									<div class="col-md-2">
										<button class="btn btn-primary" type="button"
											style="width: 150px;">
											Po Line <span id="btnPoLine" class="badge"></span>
										</button>
									</div>
									<div class="col-md-2">
										<button class="btn btn-primary" type="button"
											style="width: 150px;">
											Qty Requerida <span id="btnRequired" class="badge"></span>
										</button>
									</div>
									<div class="col-md-2">
										<button class="btn btn-primary" type="button"
											style="width: 150px;">
											Qty Almacenada <span id="btnStored" class="badge"></span>
										</button>
									</div>
								</div>
							</div>
							<div id='dataShippingInstruction'>
								<jsp:include page="TableInstruction.jsp"></jsp:include>
							</div>
						</div>
					</div>
					<br />
											...
											<div class="panel panel-gray-dark">
												...
												<div class="panel-body">
													<select name="selectProject" id="selectProject"
														class="form-control">
														<option disabled selected value="0">SELECCIONE UN
															PROYECTO</option>
													</select>
												</div>
					...
					<footer class="panel-footer" style="background-color: #5B5B5B;">
						...
						<button type="button" id="btnReprintTicket"
							name="btnReprintTicket" class="btn btn-danger btn-sm" disabled>
							<span class="glyphicon glyphicon-print"></span> Reimprimir
						</button>
...
<script src="resources/js/TicketScript.js"></script>